import Joi from 'joi';
import type { ChainId, DecimalChainId, WalletInit, WalletModule } from '@web3-onboard/common';
import type { InitOptions, WalletState, ConnectOptions, DisconnectOptions, ConnectOptionsString, AccountCenter, TransactionHandlerReturn, NotifyOptions, Notification, CustomNotification, CustomNotificationUpdate, Notify, PreflightNotificationsOptions } from './types';
